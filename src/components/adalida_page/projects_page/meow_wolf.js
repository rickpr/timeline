...
const MeowWolf = () => {
  ...
  const title = (
    <Title title='Meow Wolf' image={meowWolf} scrollTarget={contentStart} />
  )
  ...
  const problemStatementContent = (
    <div style={{ display: 'grid', minHeight: '100vh' }}>
      <div className='large-text'>
        ...
        <div className='text-warning large'>Goal Statment</div>
        <p>
          The Meow Wolf mobile app will let users purchase tickets by expediting the ticket purchasing experience.
          We will measure effectiveness by how many users purchase tickets through the app.
        </p>
      </div>
    </div>
  )
