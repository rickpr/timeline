...
`
  ...
  const grid = (
    <div style={{
      ...
      <div style={{ gridArea: 'black', backgroundColor: '#ED6112', color: '#FFFFFF', ...fullWidth }}>#ED6112</div>
      <div style={{ gridArea: 'blue', backgroundColor: '#424242', color: '#FFFFFF', ...fullWidth }}>#424242</div>
      <div style={{ gridArea: 'black-two', backgroundColor: '#424242', color: '#FFFFFF', ...fullWidth }}>&nbsp;</div>
      <div style={{ gridArea: 'purple', backgroundColor: '#212121', color: '#FFFFFF', ...fullWidth }}>#212121</div>
      <div style={{ gridArea: 'dark-gray', backgroundColor: '#C4C4C4', ...fullWidth }}>#C4C4C4</div>
      <div style={{ gridArea: 'white', backgroundColor: '#FFFFFF', ...fullWidth }}>#FFFFFF</div>
      <div style={{ gridArea: 'light-gray', backgroundColor: '#BDBDBD', ...fullWidth }}>#BDBDBD</div>
    </div>
  )
  ...
  const typography = (
    <div style={{ flexBasis: '31%', flexGrow: 3, flexShrink: 1 }}>
      ...
      <h1><SynchronizedTypewriter string='Bodoni' styles={{ fontFamily }} /></h1>
      <hr />
